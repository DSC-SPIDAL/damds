...
//        threadPartialMM = new double[threadCount][][];
    ...
    private static void calculateConjugateGradient(
        ...
        // TODO - debugs
        //System.out.println("Rank: " + ParallelOps.worldProcRank + " Tid: " + 0 + " inCG after 1st MM MMr[2600][1]: " + MMr[2600*3+1] + " MMr[7200][2]: " + MMr[7200*3+2]);
    ...
    private static void calculateMM(
        ...
        // TODO - debugs
        System.out.println("**Rank: " + ParallelOps.worldProcRank + " Tid: " + 0 + " inMM after MMInternal outMM[2600][1]: " + outMM[2600*3+1] + " outMM[7200][2]: " + outMM[7200*3+2] + " outMM[8013][2]: " + outMM[8013*3+2]);
    }
